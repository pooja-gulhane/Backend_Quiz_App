...
public class ApplicationUserTest {
    ...
    public void testUpdateUser_Success() {
        ...
        // Act
        ApplicationUserRegisterDTO updatedUser = applicationUserService.updateUser(testUser.getApplicationUserId(), testUser);

        // Assert
        assertEquals(testUser.getApplicationUserEmail(), updatedUser.getApplicationUserEmail());
    }
    ...
    public void testUpdateUser_UserNotFound() {
        ...
        // Act & Assert
        assertThrows(ResourceNotFound.class, () -> applicationUserService.updateUser(testUser.getApplicationUserId(), testUser));
    }
